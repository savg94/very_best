class DishesController < ApplicationController
  ...
  def index
    ...
    @dishes = @q.result(:distinct => true).includes(:venue, :favorite_dishes, :cuisine, :users, :venues).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def dish_params
      params.require(:dish).permit(:dish, :cuisine_id, :venue_id)
    end
end
